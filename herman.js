...
fakelink = (tekslink) => { 
	return {"externalAdReply": { "title": tekslink, "thumbnail": Aslam, "sourceUrl": "https://wa.me/qr/UCVMNO2VLMDBK1" }}
}
// AFK
	if (isGroup) {
...
herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${texxt}`, footerText: '© 𝘣𝘺 Aslam 𝘣𝘰𝘵𝘻 2022', buttons: [{ buttonId: `#donasi`, buttonText: { displayText: 'DONASI' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman3, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
${mn} *Versi* : *${os.platform()}*`
			...
			herman.updatePresence(from, Presence.composing)
                    ...
                    herman.sendMessage(from, { contentText: `${menu}`, footerText: 'Jika Kamu Menggunakan Whatsaap Mod Dan Tidak Ada Button Atau Button Tidak Respon Langsung Ketik .allmenu Saja\n• Note!! Dilarang Menyepam Bot Beri Jeda Minimal 3-5detik! Please Hargai Owner \n© 𝘣𝘺 Aslam 𝘣𝘰𝘵𝘻 2022', buttons: [{ buttonId: `${prefix}allmenu`, buttonText: { displayText: 'ALLMENU' }, type: 1 },{ buttonId: `#owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman, contextInfo: {mentionedJid: [sender, owner]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 lol = {
  "key": {
    "fromMe": false,
    participant: `6285340783774@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
• ${prefix}sandw *teks*`
              ...
              herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${menu}`, footerText: '• Subscribe Seputar Internet', buttons: [{ buttonId: `#sewa`, buttonText: { displayText: '乡SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman2, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
`
                   sendButMessage(from, wibu, `Callang Botz`, [
          {
            buttonId: `!pornmenu`,
            buttonText: {
...
case 'chiisaihentai':
              ...
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Callang Botz☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @callang172`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              herman.relayWAMessage(prep)
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Jangan Lupa Follow @callang172`},type:1}]
              ...
              herman.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'callang botz☕T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @callang172`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              herman.relayWAMessage(prep)
